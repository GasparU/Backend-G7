...
# busca el archivo .env en nuestro proyecto y si lo encuentra, configurará para python las variables de entorno definidas en ese archivo
load_dotenv()
...
SECRET_KEY = 'django-insecure-y2ht(k&+lhza7kqgg*$(eur_%m%y(2^a&bfpx8sp157+tc_vf@'
